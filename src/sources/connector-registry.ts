...
export const CONNECTORS: ConnectorDescriptor[] = [
  createConnector({
    ...
    fetch: fetchGdelt,
    normalize: (raw, fetchedAt) => normalizeGdelt(raw.articles ?? [], fetchedAt),
  }),
  createConnector({
    name: 'usgs',
  ...
  createConnector({
    ...
    costClass: 'free',
    fetch: fetchGdacs,
    normalize: (raw, fetchedAt) => normalizeGdacs(raw.features ?? [], fetchedAt),
  }),
  createConnector({
    name: 'reliefweb',
    ...
    normalize: (raw, fetchedAt) => normalizeReliefWeb(raw.data ?? [], fetchedAt),
  }),
  createConnector({
    name: 'weather',
    category: 'indicators',
  ...
  createConnector({
    ...
    costClass: 'free',
    fetch: fetchOpenAQ,
    normalize: (raw, fetchedAt) => normalizeOpenAQ(raw.results ?? [], fetchedAt),
    isSkipped: isNotConfigured,
  }),
  createConnector({
    name: 'twitter',
